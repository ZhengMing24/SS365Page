<html>
	...
	<body>
		...
		$file1=['IE_img and txt/IE_t1.txt','IE_img and txt/IE_t2.txt','IE_img and txt/IE_t3.txt','IE_img and txt/IE_t4.txt'];
		...
		$file2=['IE_img and txt/IE_t5.txt','IE_img and txt/IE_t6.txt','IE_img and txt/IE_t7.txt','IE_img and txt/IE_t8.txt'];
		...
		<div class ='con'>
			<form name="f1" action="Interactive Experience_res">		 
				...
				<div class ='row'>
					人數：<input type="number" min="1" value='1' name="people"> 
				</div>
				<div class ='row'>課程：<select name="diy" class='select'>
						<option>請選擇</option>
						<option>01/13(六)手工皂</option>
						<option>01/14(日)陶土</option>
						<option>01/20(六)木作</option>
						<option>01/21(日)多肉組盆</option>
						<option>01/27(六)擴香瓶吊飾</option>
						<option>01/28(日)手作戒指</option>
						<option>02/03(六)輕芳療調香體驗</option>
						<option>02/04(日)手繪燙金紅包袋</option>
					</select>
				</div>
